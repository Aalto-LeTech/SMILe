...
trait BufferAdapter {
   ...
   * @return
   */
  def trim(colorToTrim: Color = DefaultBackgroundColor): BufferAdapter
  ...
  def iteratePixelsWith(
      function: (Int, Int, Int, Int) => (Int, Int, Int, Int)): BufferAdapter
  ...
  def createTransformedVersionWith(
      ...
      backgroundColor: Color = DefaultBackgroundColor): (BufferAdapter, Dims)
  ...
  def createFilteredVersionWith(
      kernel: ConvolutionKernel): BufferAdapter
   ...
   */
  def createFilteredVersionWith(
      translator: ColorComponentTranslationTable): BufferAdapter
  ...
  def copyPortionXYXY(
      ...
      bottomRightYInPixels: Double): BufferAdapter
  ...
  def copyPortionXYWH(
      ...
      heightInPixels: Double): BufferAdapter
